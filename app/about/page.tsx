        ...
        <div className="min-h-screen bg-white pt-32 pb-20 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                <motion.div
                    ...
                    className="mb-16"
                >
                    <h1 className="text-4xl md:text-5xl font-display text-black mb-6">Our Story</h1>
                    <div className="space-y-6 text-gray-600 leading-relaxed">
                        <p>
                            At <span className="text-black font-medium">ÃLYSÉE</span>, we believe luxury speaks in whispers, not shouts.
                        ...
                        <p>
                            <span className="text-black font-medium">"Haute Couture S/S 2026"</span> is not just a tagline. It's a promise.
                ...
                <motion.div
                    ...
                    className="mb-16"
                >
                    <h2 className="text-2xl md:text-3xl font-display text-black mb-8">Why Choose Us</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h3 className="text-lg font-medium text-black mb-2">Timeless Design</h3>
                            <p className="text-gray-600">
                                We don't chase seasons. We create pieces that transcend time — heirlooms in the making.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-lg font-medium text-black mb-2">Uncompromising Quality</h3>
                            <p className="text-gray-600">
                                From Italian cashmere to French silk, every material is sourced from the world's finest ateliers.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-lg font-medium text-black mb-2">Minimalist Luxury</h3>
                            <p className="text-gray-600">
                                Clean lines. Neutral palettes. Bold simplicity. Our pieces speak without shouting.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-lg font-medium text-black mb-2">Personal Service</h3>
                            <p className="text-gray-600">
                ...
                >
                    <h2 className="text-2xl md:text-3xl font-display text-black mb-6">Our Promise</h2>
                    <div className="space-y-4 text-gray-600 leading-relaxed">
                        <p>
                            We make no apologies for excellence. We do not follow — we create. We do not perform — we exist.
                        </p>
                        <p>
                            <span className="text-black font-medium">ÃLYSÉE</span> is for those who appreciate the difference between being noticed and being remembered.
                        </p>
                        <p className="text-black font-medium italic pt-4">
